...
export const SITE_URL = 'https://equibeingfoundation.org';
export const SITE_ORIGIN = process.env.NEXT_PUBLIC_SITE_ORIGIN || new URL(SITE_URL).origin;
export const TWITTER_USER_NAME = 'equibeing_foundation';
export const BRAND_NAME = 'Equibeing Foundation';
export const SITE_NAME_MULTILINE = ['ACME', 'Conf'];
export const SITE_NAME = 'ACME Conf';
export const META_DESCRIPTION =
  'Insert description about Equibeing foundation here.';
